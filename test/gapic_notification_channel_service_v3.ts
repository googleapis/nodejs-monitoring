...
describe('v3.NotificationChannelServiceClient', () => {
    ...
    describe('getNotificationChannelDescriptor', () => {
        ...
        it('invokes getNotificationChannelDescriptor with error', async () => {
            ...
            await assert.rejects(async () => { await client.getNotificationChannelDescriptor(request); }, expectedError);
            assert((client.innerApiCalls.getNotificationChannelDescriptor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getNotificationChannel', () => {
        ...
        it('invokes getNotificationChannel with error', async () => {
            ...
            await assert.rejects(async () => { await client.getNotificationChannel(request); }, expectedError);
            assert((client.innerApiCalls.getNotificationChannel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createNotificationChannel', () => {
        ...
        it('invokes createNotificationChannel with error', async () => {
            ...
            await assert.rejects(async () => { await client.createNotificationChannel(request); }, expectedError);
            assert((client.innerApiCalls.createNotificationChannel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateNotificationChannel', () => {
        ...
        it('invokes updateNotificationChannel with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateNotificationChannel(request); }, expectedError);
            assert((client.innerApiCalls.updateNotificationChannel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteNotificationChannel', () => {
        ...
        it('invokes deleteNotificationChannel with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteNotificationChannel(request); }, expectedError);
            assert((client.innerApiCalls.deleteNotificationChannel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('sendNotificationChannelVerificationCode', () => {
        ...
        it('invokes sendNotificationChannelVerificationCode with error', async () => {
            ...
            await assert.rejects(async () => { await client.sendNotificationChannelVerificationCode(request); }, expectedError);
            assert((client.innerApiCalls.sendNotificationChannelVerificationCode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getNotificationChannelVerificationCode', () => {
        ...
        it('invokes getNotificationChannelVerificationCode with error', async () => {
            ...
            await assert.rejects(async () => { await client.getNotificationChannelVerificationCode(request); }, expectedError);
            assert((client.innerApiCalls.getNotificationChannelVerificationCode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('verifyNotificationChannel', () => {
        ...
        it('invokes verifyNotificationChannel with error', async () => {
            ...
            await assert.rejects(async () => { await client.verifyNotificationChannel(request); }, expectedError);
            assert((client.innerApiCalls.verifyNotificationChannel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listNotificationChannelDescriptors', () => {
        ...
        it('invokes listNotificationChannelDescriptors with error', async () => {
            ...
            await assert.rejects(async () => { await client.listNotificationChannelDescriptors(request); }, expectedError);
            assert((client.innerApiCalls.listNotificationChannelDescriptors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNotificationChannels', () => {
        ...
        it('invokes listNotificationChannels with error', async () => {
            ...
            await assert.rejects(async () => { await client.listNotificationChannels(request); }, expectedError);
            assert((client.innerApiCalls.listNotificationChannels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
