...
describe('v3.MetricServiceClient', () => {
    ...
    describe('getMonitoredResourceDescriptor', () => {
        ...
        it('invokes getMonitoredResourceDescriptor with error', async () => {
            ...
            await assert.rejects(async () => { await client.getMonitoredResourceDescriptor(request); }, expectedError);
            assert((client.innerApiCalls.getMonitoredResourceDescriptor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getMetricDescriptor', () => {
        ...
        it('invokes getMetricDescriptor with error', async () => {
            ...
            await assert.rejects(async () => { await client.getMetricDescriptor(request); }, expectedError);
            assert((client.innerApiCalls.getMetricDescriptor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createMetricDescriptor', () => {
        ...
        it('invokes createMetricDescriptor with error', async () => {
            ...
            await assert.rejects(async () => { await client.createMetricDescriptor(request); }, expectedError);
            assert((client.innerApiCalls.createMetricDescriptor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteMetricDescriptor', () => {
        ...
        it('invokes deleteMetricDescriptor with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteMetricDescriptor(request); }, expectedError);
            assert((client.innerApiCalls.deleteMetricDescriptor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createTimeSeries', () => {
        ...
        it('invokes createTimeSeries with error', async () => {
            ...
            await assert.rejects(async () => { await client.createTimeSeries(request); }, expectedError);
            assert((client.innerApiCalls.createTimeSeries as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listMonitoredResourceDescriptors', () => {
        ...
        it('invokes listMonitoredResourceDescriptors with error', async () => {
            ...
            await assert.rejects(async () => { await client.listMonitoredResourceDescriptors(request); }, expectedError);
            assert((client.innerApiCalls.listMonitoredResourceDescriptors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listMetricDescriptors', () => {
        ...
        it('invokes listMetricDescriptors with error', async () => {
            ...
            await assert.rejects(async () => { await client.listMetricDescriptors(request); }, expectedError);
            assert((client.innerApiCalls.listMetricDescriptors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTimeSeries', () => {
        ...
        it('invokes listTimeSeries with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTimeSeries(request); }, expectedError);
            assert((client.innerApiCalls.listTimeSeries as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
