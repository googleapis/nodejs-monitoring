...
describe('v3.ServiceMonitoringServiceClient', () => {
    ...
    describe('createServiceLevelObjective', () => {
        ...
        it('invokes createServiceLevelObjective with error', async () => {
            ...
            await assert.rejects(async () => { await client.createServiceLevelObjective(request); }, expectedError);
            assert((client.innerApiCalls.createServiceLevelObjective as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getServiceLevelObjective', () => {
        ...
        it('invokes getServiceLevelObjective with error', async () => {
            ...
            await assert.rejects(async () => { await client.getServiceLevelObjective(request); }, expectedError);
            assert((client.innerApiCalls.getServiceLevelObjective as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateServiceLevelObjective', () => {
        ...
        it('invokes updateServiceLevelObjective with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateServiceLevelObjective(request); }, expectedError);
            assert((client.innerApiCalls.updateServiceLevelObjective as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteServiceLevelObjective', () => {
        ...
        it('invokes deleteServiceLevelObjective with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteServiceLevelObjective(request); }, expectedError);
            assert((client.innerApiCalls.deleteServiceLevelObjective as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listServiceLevelObjectives', () => {
        ...
        it('invokes listServiceLevelObjectives with error', async () => {
            ...
            await assert.rejects(async () => { await client.listServiceLevelObjectives(request); }, expectedError);
            assert((client.innerApiCalls.listServiceLevelObjectives as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
