...
describe('v3.AlertPolicyServiceClient', () => {
    ...
    describe('getAlertPolicy', () => {
        ...
        it('invokes getAlertPolicy with error', async () => {
            ...
            await assert.rejects(async () => { await client.getAlertPolicy(request); }, expectedError);
            assert((client.innerApiCalls.getAlertPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createAlertPolicy', () => {
        ...
        it('invokes createAlertPolicy with error', async () => {
            ...
            await assert.rejects(async () => { await client.createAlertPolicy(request); }, expectedError);
            assert((client.innerApiCalls.createAlertPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteAlertPolicy', () => {
        ...
        it('invokes deleteAlertPolicy with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteAlertPolicy(request); }, expectedError);
            assert((client.innerApiCalls.deleteAlertPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateAlertPolicy', () => {
        ...
        it('invokes updateAlertPolicy with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateAlertPolicy(request); }, expectedError);
            assert((client.innerApiCalls.updateAlertPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listAlertPolicies', () => {
        ...
        it('invokes listAlertPolicies with error', async () => {
            ...
            await assert.rejects(async () => { await client.listAlertPolicies(request); }, expectedError);
            assert((client.innerApiCalls.listAlertPolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
