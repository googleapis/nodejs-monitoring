...
describe('v3.UptimeCheckServiceClient', () => {
    ...
    describe('getUptimeCheckConfig', () => {
        ...
        it('invokes getUptimeCheckConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.getUptimeCheckConfig(request); }, expectedError);
            assert((client.innerApiCalls.getUptimeCheckConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createUptimeCheckConfig', () => {
        ...
        it('invokes createUptimeCheckConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.createUptimeCheckConfig(request); }, expectedError);
            assert((client.innerApiCalls.createUptimeCheckConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateUptimeCheckConfig', () => {
        ...
        it('invokes updateUptimeCheckConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateUptimeCheckConfig(request); }, expectedError);
            assert((client.innerApiCalls.updateUptimeCheckConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteUptimeCheckConfig', () => {
        ...
        it('invokes deleteUptimeCheckConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteUptimeCheckConfig(request); }, expectedError);
            assert((client.innerApiCalls.deleteUptimeCheckConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listUptimeCheckConfigs', () => {
        ...
        it('invokes listUptimeCheckConfigs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listUptimeCheckConfigs(request); }, expectedError);
            assert((client.innerApiCalls.listUptimeCheckConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listUptimeCheckIps', () => {
        ...
        it('invokes listUptimeCheckIps with error', async () => {
            ...
            await assert.rejects(async () => { await client.listUptimeCheckIps(request); }, expectedError);
            assert((client.innerApiCalls.listUptimeCheckIps as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
